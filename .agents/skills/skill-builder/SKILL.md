...
|------|-----------------|-------------|--------|
| **Foundational** | Universal patterns, applies broadly, no explicit trigger needed | `user-invocable: false` | Add compressed summary to AGENTS.md |
...
- Personal: `~/.Codex/skills/` - Available across all projects
- Project: `.Codex/skills/` - Shared with team via git
