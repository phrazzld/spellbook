...
- **Frontmatter** (YAML): `name` and `description` are required and are the primary trigger signals Codex uses to determine when a skill should load. Some runtimes also support optional operational fields (for invocation mode/menu UX).
