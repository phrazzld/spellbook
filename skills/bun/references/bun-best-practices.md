...
│                   Prefer pnpm When:                     │
├─────────────────────────────────────────────────────────┤
│ Expo/EAS builds (Node.js required)                      │
│ Vercel serverless (limited Bun support)                 │
│ Complex native module dependencies                      │
│ Team unfamiliar with Bun quirks                         │
│ Production apps needing maximum stability               │
│ Projects with extensive Node.js API usage               │
└─────────────────────────────────────────────────────────┘
```
